...
DATA_FILE_NAME = 'output/draw_nums.json'
INPUT_COUNT = 45
OUTPUT_COUNT = 10
...
nn.add_layer(25, random_radius=2)  # добавляем скрытый слой
...
if import_data:
    ...
    input_list = tools.import_json_file('input/draw_nums/input.json')
    ...
    tools.export_file('output/draw_nums_losses.txt', ''.join(epoch_losses_formatted))
